...
function Chatbot() {
    ...
    const [stats, setStats] = useState({
        ...
        lastActive: new Date(),
        expertise: ['General Knowledge', 'Q&A Support', 'Information Assistant']
    });
    ...
    const handleSubmit = async (e, customQuery = null) => {
        ...
        try {
            ...
            const response = await handleRequestWithTimeout(async () => {
    ...
    const startNewChat = () => {
        const greeting = `${getGreeting()} ${userName}! How can I help you today?`;
        setMessages([{ 
            type: "bot", 
            text: greeting, 
            timestamp: new Date(),
